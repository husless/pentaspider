...
// configuration step. It creates a namespace called `pentaspider`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        pentaspider::cmake::project_name,
        pentaspider::cmake::project_version));// version string, acquired
